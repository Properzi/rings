...
one can prove the following result: An integer $n\geq2$ can be written as a sum of two squares if and only if its prime decomposition contains no factor $p^k$, where 
$p\equiv 3\bmod 4$ 
and $k$ is odd. 
...
\index{Eisenstein integers}
    This exercise is about \textbf{Eisenstein integers}. 
