...
The division algorithm shows that every ideal of $\Z$ is principal, see Exercise~\ref{xca:ideals_Z}.  
...
polynomial ring $K[X]$. Then one proves that every ideal of $K[X]$ is principal.  
...
\begin{exercise}
	Let $R$ be the ring of continuos maps $[0,2]\to\R$. Prove that the set 
