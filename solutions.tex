...
homomorphism $\varphi\colon\R[G]\to\R\times\C$. Since $\{(1,0),(1,\omega),(1,\omega^2)\}$ 
is a subset of the image of $\varphi$ that is 
linearly independent over $\R$ and $\dim_\R\R\times\C=\dim\R[G]=3$, it follows that $\varphi$ is a bijective. 
\end{sol}
