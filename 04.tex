...
\begin{example}
	...
	\[
 4=N(x)=N(\alpha)N(\beta).
 \]
 Thus $N(\alpha)\in\{1,2,4\}$. 
...
%
%	If $N(\alpha)=2$, then $a^2+3b^2=2$ and then $a$ and $b$
...
The previous examples suggest why for the definition of an euclidean domain one needs to  
