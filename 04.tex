...
\begin{example}
	...
	Let us now perform the explicit calculation. Let $\alpha=a+ib$ and $\beta=c+id$. 
	Write 
	\[
...
\end{tikzpicture}
\caption{$\C$ is covered by open unit disks of radius one and centers in Gauss integers.}
\label{fig:covering}
\end{figure}
