...
that although we use the same notation for different representations there is no risk of confusion. 
...
\begin{proof}
    ...
    product on $V$. A straightforward calculation shows that
    \[
